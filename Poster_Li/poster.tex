...
\section*{\color{NavyBlue}Ablation study}

\begin{minipage}[m]{0.46\linewidth}
%\raggedright
%\vspace*{10pt}
\centering 
\hspace*{40pt}{\includegraphics[width=0.8\linewidth]{remove_features_individually_Testing.pdf}}
\vspace*{10pt}
...
%\vspace*{-30pt}
\centering 
\color{Black}{\includegraphics[width=\linewidth]{CNN_RNN_ensemble.pdf}}
...
\section*{\color{NavyBlue}Evolutionary conservation}

\begin{center}
\color{Black}{\includegraphics[width=1.0\linewidth]{figures/combined_conver.png}}
...
\begin{center}
\color{Black}{\includegraphics[width=1.0\linewidth]{Model_architecture.pdf}}
...
\begin{center}
\color{Black}{\includegraphics[width=1.0\linewidth]{many_2_one.pdf}}
...
\centering 
\color{Black}{\includegraphics[width=.82\linewidth]{figures/delphi_web.png}}
